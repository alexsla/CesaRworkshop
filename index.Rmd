...
### Import the dataset (workshop_2_data.csv) and store it as an object named `data1`.
...
```{r, webex.hide="Click here to see the solution"}
df_fin %>%
  ggplot(aes(x = Growth, y = Survival)) +
  geom_point() +
...
We'd love to, but plotting is an entire can of worms. But if you found this workshop useful, let us know! We might be able to put on another workshop focusing on data visualisation.
